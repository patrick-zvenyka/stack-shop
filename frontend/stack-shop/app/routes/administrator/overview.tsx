...
export const meta: MetaFunction = () => {
  return [
    { title: "System Overview | StackShop Admin" },
    { name: "description", content: "Enterprise system overview and live metrics." },
  ];
};
...
// Helper components moved into this file for now, or could be move to components directory
