...
export const meta: MetaFunction = () => {
  return [
    { title: "Administrator Dashboard | Stack Shop" },
    { name: "description", content: "Administrator system view" },
  ];
};
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
      <div className="max-w-7xl mx-auto">
        <header className="mb-8 flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Administrator Dashboard</h1>
            <p className="mt-2 text-gray-600 dark:text-gray-400">System management and configuration</p>
          </div>
          <Link 
