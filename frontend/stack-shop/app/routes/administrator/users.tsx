...
const INITIAL_USERS: User[] = [
  { id: "1", name: "Alexander Vance", email: "vance.a@stackshop.io", role: "Root Admin", rank: "Level 9", status: "active" },
  { id: "2", name: "Sarah Chen", email: "chen.s@stackshop.io", role: "Finance Lead", rank: "Level 7", status: "active" },
  { id: "3", name: "Marcus Thorne", email: "thorne.m@stackshop.io", role: "Field Agent", rank: "Level 4", status: "away" },
  { id: "4", name: "Elena Rodriguez", email: "rodriguez.e@stackshop.io", role: "Inventory Mgr", rank: "Level 6", status: "active" },
];
